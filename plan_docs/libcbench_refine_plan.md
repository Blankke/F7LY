...
libcbench 四组合均已完整跑完，官方 judge 脚本可解析子项 108/108，缺项 0。当前 RISC-V 得分 62.908，LoongArch 得分 67.065，四组合合计 129.973，较官方 baseline floor 108 高 21.973 分；重点补齐了 RISC-V glibc/musl 的 pthread、regex、malloc 线程相关缺项。
