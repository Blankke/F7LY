...
BUDDY_EXT UINT buddy_used_bytes(void);
BUDDY_EXT void buddy_usage_details(UINT *punTotalBytes, UINT *punUsedBytes, UINT *punMaxFreedPageSize, UINT *punMinFreedPageSize);
#endif
